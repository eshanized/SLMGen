            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        {[
                            { icon: '📊', title: 'Dataset Intelligence', desc: 'Quality scoring, personality detection, and hallucination risk analysis' },
                            { icon: '🎯', title: '100-Point Matching', desc: 'AI-powered model selection based on your data and deployment needs' },
                            { icon: '⚡', title: 'Unsloth Optimization', desc: '2x faster training with 70% less VRAM on free Colab GPUs' },
                            { icon: '📓', title: 'Ready-to-Run Notebooks', desc: 'Self-contained Jupyter notebooks with embedded datasets' },
                        ].map((item) => (
                            <div key={item.title} className="p-4 bg-[#1e2528] border border-[#2d3437] rounded-xl">
                ...
                {/* Creator */}
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-[#dadada] mb-6">Creator</h2>
                    <div className="flex items-center gap-6 p-6 bg-[#1e2528] border border-[#2d3437] rounded-xl">
                        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#8ccf7e] to-[#6cbfbf] flex items-center justify-center text-3xl font-bold text-[#141b1e]">
                            E
                        </div>
                        <div>
                            <h3 className="text-xl font-semibold text-[#dadada]">Eshan Roy</h3>
                            <p className="text-[#8a9899] mb-2">Creator & Maintainer</p>
                            <div className="flex gap-4">
                                <a
                                    href="https://github.com/eshanized"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-[#8ccf7e] hover:underline text-sm"
                                >
                                    GitHub
                                </a>
                                <a
