                ...
                <div className="space-y-8">
                    <section>
                        ...
                        <div className="text-zinc-400 space-y-4">
                            <p><strong className="text-white">Account Information:</strong> Email address, name, and avatar URL when you create an account.</p>
                            <p><strong className="text-white">Dataset Data:</strong> JSONL files you upload for processing. These are stored temporarily and deleted after your session expires.</p>
                            <p><strong className="text-white">Usage Data:</strong> Information about how you use the Service, including job history and preferences.</p>
                        </div>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="p-4 bg-violet-600/10 border border-violet-500/30 rounded-xl text-zinc-400">
                            <p className="text-violet-400 font-semibold mb-2">Key Point:</p>
                            <p>
                    ...
                    <section>
                        ...
                        <p className="text-zinc-400 leading-relaxed">We use the following third-party services:</p>
                        <ul className="list-disc list-inside text-zinc-400 space-y-2 mt-4">
